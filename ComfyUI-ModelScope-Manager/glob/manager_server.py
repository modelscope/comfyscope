...
@PromptServer.instance.routes.post("/customnode/reset")
async def modelscope_reset_personal_customnodes(request):
    print(f"Reset personal custom nodes...")
    print(f"Cleaning all custom nodes installed...")
    os.system("rm -rf /mnt/comfyui-test/custom_nodes_users/${USER_NAME}/*")
    print(f"Cleaning done.")

    print(f"Initializing with pre-installed custom nodes...")
